...
namespace Testing
{
    public class UnitTest1
    {
        ...
        public void Test2()
        {
            String queryResult = "SELECT Name, Price, Stock FROM Products WHERE Name='Juan' AND Price>32.5 GROUP BY Price ORDER BY Stock DESC;";
            ...
            SearchCriteria criteria = new SearchCriteria(select, filters, group, order);
